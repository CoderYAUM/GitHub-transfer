...
import com.ccnu.studentsystem.Student;
...
//                    System.exit(0);
    ...
    public static void addStudent(ArrayList<com.ccnu.studentsystem.Student>list){
        com.ccnu.studentsystem.Student s=new com.ccnu.studentsystem.Student();
        Scanner sc=new Scanner(System.in);
...
//        s.setAge(age);
    ...
    public static void deleteStudent(ArrayList<com.ccnu.studentsystem.Student>list){
        Scanner sc=new Scanner(System.in);
    ...
    public static void updateStudent(ArrayList<com.ccnu.studentsystem.Student>list){
        Scanner sc=new Scanner(System.in);
